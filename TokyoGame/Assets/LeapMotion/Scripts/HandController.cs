...
public class HandController : MonoBehaviour {
  ...
  */
  ...
  void Start() {
      var hand_controller_config = GetComponent<HandControllerConfig>();
      leap_controller_.EnableGesture(Gesture.GestureType.TYPE_CIRCLE);
      leap_controller_.Config.SetFloat("Gesture.Circle.MinArc", hand_controller_config.minArc);
      leap_controller_.Config.SetFloat("Gesture.Circle.MinRadius", hand_controller_config.minRadius);
      leap_controller_.Config.Save();
      turn_num_ = hand_controller_config.turnNum;
